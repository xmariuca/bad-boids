...
boids_number = 50
master_of_boids = BoidsMaster(position_limits, velocities_limits,
                              boids_number)
...
scatter = axes.scatter(master_of_boids.positions[0, :],
                       master_of_boids.positions[1, :])


def animate(frame):
    master_of_boids.update_boids()
    scatter.set_offsets(zip(master_of_boids.positions[0, :],
                            master_of_boids.positions[1, :]))
